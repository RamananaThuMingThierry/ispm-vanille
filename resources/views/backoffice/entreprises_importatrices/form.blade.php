<div class="modal fade" id="entrepriseImportatriceModal" tabindex="-1" aria-labelledby="entrepriseImportatriceModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <form id="entrepriseImportatriceForm">
                @csrf
                <input type="hidden" id="entreprise_importatrice_id" name="entreprise_importatrice_id">
                <div class="modal-header">
                    <h5 class="modal-title" id="entrepriseImportatriceModalLabel">Nouvelle entreprise importatrice</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn-save-entreprise-importatrice">
                        {{ __('form.save') }}
                    </button>
                </div>
            </form>
