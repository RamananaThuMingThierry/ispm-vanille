<div class="modal fade" id="entrepriseShowModal" tabindex="-1" aria-labelledby="entrepriseShowModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="entrepriseShowModalLabel">
                    {{ __('sidebar.entreprise_exportatrice') }} - {{ __('form.details') ?? 'Détails' }}
                </h5>
